...
const asSimpleArray = data.VOUCHER.map(element => {
    return {
        ...
        basicBuyerName: element.BASICBUYERNAME,
        partyMailingName: element.PARTYMAILINGNAME,
        consigneeMailingName: element.CONSIGNEEMAILINGNAME,
        consigneeStateName: element.CONSIGNEESTATENAME,
        basicBasePartyName: element.BASICBASEPARTYNAME,
